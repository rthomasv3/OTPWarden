...
public partial class PostgresDbContext : OTPDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UserData>(entity =>
        {
            ...
            entity.Property(e => e.Created).HasColumnType("timestamp with time zone").HasPrecision(2);
            entity.Property(e => e.Email).HasMaxLength(1024);
            entity.Property(e => e.LastLogin).HasColumnType("timestamp with time zone").HasPrecision(2);
        ...
        modelBuilder.Entity<UserSessionData>(entity =>
        {
            ...
            entity.Property(e => e.Created).HasColumnType("timestamp with time zone").HasPrecision(2);
            entity.Property(e => e.RefreshTokenExpiration).HasColumnType("timestamp with time zone").HasPrecision(2);
            entity.Property(e => e.Updated).HasColumnType("timestamp with time zone").HasPrecision(2);
